...
%% modified by libaohe, 2012-9-26, ignore
%%-----------------------------BEGIN--------------------------------
...
build_typed_attribute({atom,La,Attr},
    ...
    case lists:all(fun({var, _, _}) -> true;
        ...
        true -> {attribute,La,list_to_atom(Attr),{TypeName,Type,Args}};
...
%% only support: module, export, record & file
%%-----------------BEGIN----------------------
